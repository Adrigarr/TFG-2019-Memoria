...
\begin{figure}[h!]
	\centering
	\includegraphics[width = 0.9\textwidth]{Imagenes/Bitmap/RDFexample.png}
	\caption{Ejemplo de grafo siguiendo el modelo RDF}
	\label{fig:sampleImage}
\end{figure}

A simple vista para una persona, puede resultar una nomenclatura poco amigable de representar ya que las URIs pueden llegar a ser mucho más engorrosas y complejas. Más adelante explicaremos como hemos resuelto este problema en nuestro proyecto para que cualquiera que haga uso de nuestra futura interfaz pueda reconocer todos los objetos y sobre todo para darnos mucha más comodidad a la hora de trabajar con ellos.\\
