...
Cabe señalar que el sistema RDF, es un modelo de representación pero existen muchos formatos comúnmente usados que siguen la filosofía de este modelo: RDF/XML, RDFa, Turtle o N-triples. Todos ellos eficaces en cuanto al manejo de datos enlazados.
