...
La métrica Género es una de las más representativas ya que las personas se guían por el género que prefieren en orden a escuchar canciones similares, aunque en ocasiones no deba ser así. Un usuario que sea fan del Jazz querrá escuchar canciones de ese mismo género o géneros similares.\\
...
El principal método que hemos establecido es proseguir el estudio de las métricas directas creando un grafo en forma de árbol.
Para cada una de las métricas directas ejecutaremos más consultas SPARQL obteniendo
