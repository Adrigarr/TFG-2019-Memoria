...
Como se podrá observar en la figura, una ficha de Wikidata contiene un conjunto de tuplas propiedad-identificador. Por ejemplo, en este caso se señala que la propiedad Género de la canción tiene un identificador Funk entre otros). A su vez a  identificador Funk le corrsponderá un código que no es más que una uri que nos trasladará a la propia ficha de este tipo de género musical. Así es como se aplica este sistema enlazado de información en Wikidata.
