...
En una primera fase, buscaremos explicaciones básicas para relacionar diferentes tipos de canciones, por ejemplo: género, artista, tipo de voz, etc. Después buscaremos explicaciones más complejas que normalmente un humano pasaría por alto. Asignaremos una complejidad de k=1 a las explicaciones básicas. Estas explicaciones son una relación directa entre dos canciones relacionadas por una propiedad.\\
...
Una de las explicaciones más importantes es la \textbf{década}. La fecha en que se han publicado las canciones es relevante para establecer su relación, ya que dos canciones que pertenezcan a la misma década pueden ser igualmente interesantes para un mismo usuario aunque no exista una relación directa entre ellas.\\
