...
La clase Properties, se encarca de establecer y configurar todas las propiedades que se van a estudiar sobre cada canción. Al crear una instacia de la clase, importa una serie de diccionarios que son almacenados. Cabe destacar que estos diccionarios son inicialmente estáticos ya que en un principio cuantan con las propiedades que hemos estudiado y probado aunque cuentan con la posibilidad de expandirse añadiendo nuevas propiedades, siempre que cuenten con la sintaxis de Wikidata. \\

Por último tenemos el módulo dataOperations, el cual es utilizado a modo auxiliar para poder convertir y hacer operaciones con los ditintos dataFrames de información que se van creando continuamente al hacer un estudio de una canción.\\


\begin{figure}[h!]
	\centering
	\includegraphics[width = 0.75\textwidth]{Imagenes/Bitmap/class-diagram.png}
